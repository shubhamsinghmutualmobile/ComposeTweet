...
object UserStoriesRepository {
    ...
    fun fetchStories(): List<UserStory> {
        ...
        stories.add(
            UserStory(
                "Guweiz",
                "https://pbs.twimg.com/profile_images/1025381228285816832/tyjd7Xxr_400x400.jpg"
            )
        )
        stories.add(
            UserStory(
                "OnePlus",
                "https://pbs.twimg.com/profile_images/1295555226720641026/gTnCg1RF_400x400.jpg"
            )
        )
        stories.add(
            UserStory(
